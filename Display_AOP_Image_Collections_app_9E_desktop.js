...
var imageCollections = {
  ...
  "Derived Indices/Terrain Products (HSI_REFL/002)": ee.ImageCollection("projects/neon-prod-earthengine/assets/HSI_REFL/002")
};
...
var scriptTemplates = {
  ...
  "Canopy Nitrogen Concentration (CNC/002)": {
    ...
    collectionName: "CNC",
    bands: "['nitrogen']",
    visParams: "{bands: ['nitrogen'], min: 0, max: 4, palette: ['#440154', '#3b528b', '#21908c', '#5dc963', '#fde725']}",
...
function generateSampleScript() {
  ...
  if (selectedCollection === 'Derived Indices/Terrain Products (HSI_REFL/002)') {
  ...
  if (selectedCollection === "Digital Surface Model (DEM/001)") {
    ...
    selectedImage.get('FLIGHT_YEAR').evaluate(function(year) {
      ...
      if (selectedBand === 'Canopy Nitrogen Model Uncertainty') {
        ...
        visParamsString = '{bands: [\'nitrogen\'], min: ' + dynamicParams.min.toFixed(2) + ', max: ' + dynamicParams.max.toFixed(2) + ', palette: [\'#440154\', \'#3b528b\', \'#21908c\', \'#5dc963\', \'#fde725\']}';
      }
...
function exportCroppedImage() {
  ...
  var isDerivedExport = selectCollection1.getValue() === 'Derived Indices/Terrain Products (HSI_REFL/002)';
  if (isDerivedExport) {
...
function updateMap(selectedImageName1, selectedImageName2, visParams) {
  ...
  if (selectCollection1.getValue() === 'Derived Indices/Terrain Products (HSI_REFL/002)') {
  ...
  if (selectedImage2) {
    if (selectCollection2.getValue() === 'Derived Indices/Terrain Products (HSI_REFL/002)') {
