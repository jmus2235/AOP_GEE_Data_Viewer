...
// Map to format dropdown items
var dropdownItems = siteNamePairs.map(function(pair) {
  var site = pair[0]; // NEON_SITE
  var name = pair[1] || 'Unknown'; // NEON_SITE_NAME, default to 'Unknown' if missing
...
var linkLabelDV = ui.Label({
  value: 'Desktop AOP Data Viewer', 
  style: {color: 'blue', textDecoration: 'underline', fontSize: '10px', fontWeight: 'bold', },
  targetUrl: 'https://neon-prod-earthengine.projects.earthengine.app/view/neon-aop-gee-data-viewer---desktop'
});
...
URLhorizontalPanel.add(linkLabelDV);
